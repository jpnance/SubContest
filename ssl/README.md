...
The runt uses [mkcert](https://github.com/FiloSottile/mkcert) to generate locally-trusted certificates. It creates `subcontest-key.pem` and `subcontest.pem` for `subcontest.coinflipper.local`.
